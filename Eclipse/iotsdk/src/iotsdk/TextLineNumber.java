	...
	implements CaretListener, DocumentListener, PropertyChangeListener
{
	...
	private static final long serialVersionUID = 4185204358799953427L;
	...
	{
		super.setBackground(ClaireSDK.settings.bkgc1);
		super.setBorder(BorderFactory.createEmptyBorder());
		this.component = component;
		this.setForeground(ClaireSDK.settings.plainText);
		setFont( component.getFont() );

		setBorderGap( 5 );
		setCurrentLineForeground(ClaireSDK.settings.plainText2);
